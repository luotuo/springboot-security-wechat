...
@EnableJpaRepositories(basePackages = "com.luotuo.user.repository", entityManagerFactoryRef = "secondEntityManagerFactory",transactionManagerRef = "secondTransactionManager")
